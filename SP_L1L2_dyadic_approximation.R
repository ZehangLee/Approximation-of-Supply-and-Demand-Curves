...
#### 1.1.1 Obtain a reasonable number of nodes by minimizing the mean approximation #### 

n_curve = max(day_ahead_supply$time)
n_nodes = 50

M = matrix(NA,nrow = 0,ncol=5)
colnames(M) = c('error','approx_p','approx_q','l_boundary','r_boundary')

lst_CurvE = rep(list(M),n_curve)
Interval_E = M[,c(1,4,5)]

lst_Interval_E = rep(list(Interval_E),n_nodes)
maxp =  max(day_ahead_supply$p_scaled)
minp =  min(day_ahead_supply$p_scaled)
...
for(n in 2:n_nodes){
  ...
  for(cc in 1:n_curve){
    ...
    print(paste0('n_nodes=',n,'; ','curve=',cc))
    
    E= lst_CurvE[[cc]]
    if(n>2) {E = E[-Interval_drop,]}
    ...
    left = f_interval_approx_error(cp,cq,Il[1],Il[2], 
                                   Vectorize(supply.mixture.gamma),l=1,increasing = T )
    
    right = f_interval_approx_error(cp,cq,Ir[1],Ir[2], 
                                    Vectorize(supply.mixture.gamma),l=1,increasing = T)
...
save_path1 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_supply_GammaWeight_L1_lst_CurvE_",n_nodes,"nodes",".RData",sep = "")
save(lst_CurvE,file=save_path1)
save_path2 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_supply_GammaWeight_L1_lst_Interval_E_",n_nodes,"nodes",".RData",sep = "")save(lst_Interval_E,file = save_path2)
...
L1_Approx_Dyadic_50nodes=foreach(i=1:max(day_ahead_supply$time),.combine='c', .options.snow=opts,.packages = c("cubature","nor1mix")) %dopar% {
  ...
  res = sapply(1:n, function(m) f_interval_approx_error(cp,cq,
...
save_path = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_supply_GammaWeight_L1+dyadic_",n,"nodes2",".RData",sep = "")
...
#### 1.2.1 Obtain a reasonable number of nodes by minimizing the mean approximation #### 
...
for(n in 2:n_nodes){
  ...
  for(cc in 1:n_curve){
    ...
    left = f_interval_approx_error(cp,cq,Il[1],Il[2], 
                                   Vectorize(supply.mixture.gamma),l=2,increasing = T)
    right = f_interval_approx_error(cp,cq,Ir[1],Ir[2], 
                                    Vectorize(supply.mixture.gamma),l=2,increasing = T)
...
save_path1 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_supply_GammaWeight_L2_lst_CurvE_",n_nodes,"nodes",".RData",sep = "")
save(lst_CurvE,file=save_path1)
save_path2 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_supply_GammaWeight_L2_lst_Interval_E_",n_nodes,"nodes",".RData",sep = "")save(lst_Interval_E,file = save_path2)
...
save_path = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_supply_GammaWeight_L2+dyadic_",n,"nodes2",".RData",sep = "")
...
#### 2.1.1 Obtain a reasonable number of nodes by minimizing the mean approximation #### 
...
lst_Interval_E = rep(list(Interval_E),n_nodes)
maxp =  max(day_ahead_demand$p_scaled)
minp =  min(day_ahead_demand$p_scaled)
...
save_path1 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_demand_GammaWeight_L1_lst_CurvE_",n_nodes,"nodes",".RData",sep = "")
save(lst_CurvE,file=save_path1)
save_path2 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_demand_GammaWeight_L1_lst_Interval_E_",n_nodes,"nodes",".RData",sep = "")
...
save_path = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_demand_GammaWeight_L1+dyadic_",n,"nodes2",".RData",sep = "")
save(L1_Approx_Dyadic_50nodes,file=save_path)
...
#### 2.2.1 Obtain a reasonable number of nodes by minimizing the mean approximation #### 
...
save_path1 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_demand_GammaWeight_L2_lst_CurvE_",n_nodes,"nodes",".RData",sep = "")
save(lst_CurvE,file=save_path1)
save_path2 = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_demand_GammaWeight_L2_lst_Interval_E_",n_nodes,"nodes",".RData",sep = "")
save(lst_Interval_E,file = save_path2)
...
save_path = paste("C:/Zehang_workspace/Approximation_Supply_Demand/gamma weight approximation/sp_day-ahead_demand_GammaWeight_L2+dyadic_",n,"nodes2",".RData",sep = "")
save(L2_Approx_Dyadic_50nodes,file=save_path)
